...
export function HeartRateMetric({ data }: { data: HeartRateData[] }) {
          ...
          <CardContent>
            <div className="flex items-center justify-center py-4">
              <div className="text-center flex items-baseline">
                ...
                <div className="text-sm text-[#86868B] ml-2">
                  {latestReading.unit}
                </div>
              </div>
            </div>
            {latestReading.isAbnormal && (
              <div className="mt-2 p-2 bg-red-100 text-red-800 rounded-md text-sm">
                Atenção: Valor fora da faixa normal (60-100 bpm)
              </div>
            )}
            {latestReading.notes && (
        ...
        <Card>
          <CardContent className="pt-6 text-center">
            <p className="text-[#86868B]">
              Nenhuma medição de frequência cardíaca registrada.
            </p>
          </CardContent>
        </Card>
      )}
